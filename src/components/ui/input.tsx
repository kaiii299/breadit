...
export default function useInput(placeholder: string, spanClassName?: string, inputClassName?: string, callBack?: CallableFunction) {
  ...
  return {
    ...
    <div className=" flex justify-start items-center">
      <label className='relative cursor-pointer'>
        <input value={inputValue} onChange={handleInputChange} type="text" placeholder="Input" className={inputClassName ? inputClassName : inputClassName } />
